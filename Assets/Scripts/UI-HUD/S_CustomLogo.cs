...
public class S_CustomLogo : MonoBehaviour
{
    ...
    private Color _defaultBackgroundColor = Color.white; // Couleur par d�faut de fond
    private Color _defaultOverlayColor = Color.white;    // Couleur par d�faut d'incrustation
    ...
    void LoadLogo()
    {
        ...
        if (S_DataGame.Instance != null)
        {
            ...
            if (!string.IsNullOrEmpty(backgroundColorHex))
            {
                ...
                {
                    // Appliquer la couleur de fond charg�e avec alpha
            ...
            // Charger l'image d'incrustation s�lectionn�e dans le dropdown
    ...
    {
        // R�initialiser les couleurs aux valeurs par d�faut
        ...
        // R�initialiser l'image d'incrustation � la premi�re image ou � une valeur par d�faut
