...
public class AudioLoader : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        float masterVolume = PlayerPrefs.GetFloat("masterSoundVolume", 1);
        float musicVolume = PlayerPrefs.GetFloat("musicSoundVolume", 1);
        float sfxVolume = PlayerPrefs.GetFloat("sfxSoundVolume", 1);
        ...
        switch (_audioType)
        {
            ...
            case AudioType.SFX:
                ...
                if (_soundManager != null) _soundManager.SFXChangedEvent.AddListener(RefreshSFXVolume);
                break;
            default: 
                break;  
        }
